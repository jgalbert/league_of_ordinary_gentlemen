/*   STEP 1   */
export const leagueID = "1049388190487986176"; // your league ID
...
export const managers = [
  ...
  },
  {
    ...
    "managerID": "690340887720431616",  // the user's manager ID, go to https://api.sleeper.app/v1/league/<your_league_id>/users to find user IDs (you can use older leagueIDs to find user IDs for managers that are no longer in the league)
    "name": "Tyler Strevel",
    "tookOver": null, // (optional) used if a manager took over a team, delete this line or change to null otherwise
    "location": "Sparta, MI", // (optional)
    "bio": "I am a loving husband with a 7 year old son and doggy dad. I love spending time with family. I'm an outdoors type of guy, anything from a garden to hunting and fishing.",
    ...
    "philosophy": "Overthink every possible roster spot until I make the wrong choice...then stick with it!",
